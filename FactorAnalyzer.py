...
class RankFactorAnalyzer:
    ...
    def factors_select_daily(self,
        ...
        if save:
            ...
            print(f"long factors saved to .//data//{symbol}_daily_select_long_factors.parquet")
            print(f"short factors saved to .//data//{symbol}_daily_select_short_factors.parquet")
